...
the script outputs the missing or incorrect EC2 tag data into html tables in index.html, this is published to aws instance running apache2, vhost is tagcheck.conf.
